...
namespace TemplateCoreMaterial.Repository.Tests.User
{
  ...
  /// <summary>
  /// Class test that tests the method FindManyByAsync of the <see cref="Repository{TEntity}"/> class.
  /// </summary>
  public class FindManyByAsync
  {
    ...
    public async Task FindManyByAsyncOk()
    {
      ...
      // act
      var user = await this.unitOfWork.UserRepository.FindManyByAsync(x => x.Name.Contains("test"));
